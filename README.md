...
[![Typing SVG](https://readme-typing-svg.herokuapp.com/?color=36a81d&size=35&center=true&vCenter=true&width=1000&lines=Olá,+prazer,+me+chamo+Pedro+Henrique;+discente+no+curso+Ciência+da+Computação+no+IFCE;Seja+bem+vindo+ao+meu+GitHub!+(ツ)%29)](https://git.io/typing-svg) 
